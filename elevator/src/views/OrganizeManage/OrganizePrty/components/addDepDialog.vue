      ...
      <div class="add_dep_main">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
          ...
          <el-form-item label="单位类型" prop="type" class="change_input">
            <el-select v-model="ruleForm.type" placeholder="请选择单位类型" clearable :disabled="states == 1">
              <el-option
        ...
        <div class="bottom_btn">
          ...
          <el-button class="list_btn" type="primary" :loading="createLoading" v-if="states == 0" @click="submitForm('ruleForm')">立即创建</el-button>
          <el-button class="list_btn" type="primary" :loading="createLoading" v-if="states == 1" @click="editForm('ruleForm')">确认修改</el-button>
        </div>
      </div>
    </el-drawer>
  </div>
