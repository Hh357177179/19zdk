...
Page({
  ...
  getDetail () {
    ...
    postRequest('/user/cardDetail', params, true).then(res => {
      console.log(res)
      that.setData({
        obj: res
      })
  ...
  buyCard () {
    ...
    postRequest('/user/cardOrderCreate', params, true).then(res => {
      console.log(res)
      let param = {
        token: app.globalData.unionid,
        order_id: res.order_id
      }
      postRequest('/user/cardOrderPay', param, true).then(res => {
        console.log(res)
