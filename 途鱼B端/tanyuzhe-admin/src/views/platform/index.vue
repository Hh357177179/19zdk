<template>
  <div class="app-container">
    ...
    <el-table :data="items" style="width: 100%;margin-top:30px;" border>
      <el-table-column align="center" label="用户账户" width="220">
      ...
      <el-table-column align="header-center" label="账号类型">
        <template slot-scope="scope">
...
import { getStaff } from '@/api/user.js'
